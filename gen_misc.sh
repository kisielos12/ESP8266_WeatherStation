...
example:
export SDK_PATH=../SDK_RTOS
export BIN_PATH=./output
!

source config.mk

#export SDK_PATH=$PWD/../SDK_RTOS
#export BIN_PATH=./output
...
echo $boot > cfg.ini
echo $app >> cfg.ini
echo $spi_speed >> cfg.ini
echo $spi_mode >> cfg.ini
echo $spi_size_map >> cfg.ini

make clean

make BOOT=$boot APP=$app SPI_SPEED=$spi_speed SPI_MODE=$spi_mode SPI_SIZE_MAP=$spi_size_map

echo "[ Now u can use a JK scripts, cause the settings of compilations are saved ]"
